		...
		<div id="main">		
			<?php if ( $_GET['add'] == 'true' ) : ?>
				<p style="background: #fef1b5; border: 1px solid #eedc82; padding: 7px 10px;">
					You've successfully added a new merchant.
				</p>
			<?php endif; ?>
			...
			<form id="product-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				<div id="product-left">
					<table class="entry-table">
						<tr>
							<td><p>Name</p><input class="input-text" type="text" name="merchant_name" /></td>
						</tr>
						<tr>
							<td><p>Contact</p><input class="input-text" type="text" name="merchant_contact" /></td>
						</tr>
						<tr>
							<td><p>Phone Number</p><input class="input-text" type="text" name="merchant_phone" /></td>
						</tr>
						<tr>
							<td><p>Image</p><input id="image-upload-input" class="input-text" type="text" name="merchant_image" /><a class="image-upload-button" href="<?php echo $ja->getAdminURL(); ?>/add-media.php">Upload Image</a></td>
						</tr>
